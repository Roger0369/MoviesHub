const moviesCatalog = [
    ...
    image: "./img/madmax_furyroad.webp",
    infoPage: "./movies_files/madmax.html"
  },
  {
    name: "John Wick",
    category: "action",
    description: "Un exasesino regresa al mundo del crimen para vengar la muerte de su perro, un regalo de su esposa fallecida.",
    image: "./img/johnwick.webp",
    infoPage: "./movies_files/johnwick.html"
  },
  {
    name: "Deadpool",
    category: "action",
    ...
    image: "./img/deadpool.webp",
    infoPage: "./movies_files/deadpool.html",
  },
  {
    name: "Mickey 17",
    category: "fiction",
    description: "Mickey es clonado accidentalmente, dos versiones de su personalidad se ven obligadas a trabajar juntas.",
    image: "./img/mickey17.webp",
    infoPage: "./movies_files/mickey17.html"
  },
]